...
| `process-api-block-local.txt` | `--block-local-connections` evidence: clap flag/help, crate proof (`nix` getifaddrs, `tokio-vsock`), verbatim SECURITY log strings, reconstructed logic. |
